...
static u64 _zswap_accesses_count = 0;
...
spinlock_t _zswap_accesses_lock;
...
{
	struct zswap_tree *tree;
	spin_lock(&_zswap_accesses_lock);
    _zswap_accesses_count += 1;
    spin_unlock(&_zswap_accesses_lock);
...
static int __init zswap_debugfs_init(void)
{
	...
	debugfs_create_u64("zswap_accesses_count", S_IRUGO,
			zswap_debugfs_root, &_zswap_accesses_count);
...
static int __init init_zswap(void)
{
	...
	spin_lock_init(&_zswap_accesses_lock);
